    ...
    <section className="bg-green-100 container mx-auto text-black  py-6 px-4 rounded-2xl mt-16">
      <div className="container mx-auto text-center">
        ...
        <p className="text-xl mb-6">
          Welcome to <strong className="text-green-500">Our Pet Adoption Platform</strong> – your one-stop destination to find your forever friend!
        </p>
        ...
        <div className="text-center mb-12">
          ...
          <div className="md:flex justify-center gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-bold mt-2">Browse Available Pets</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-bold mt-2">Learn About Each Pet</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-bold mt-2">Contact Shelters & Adoption Centers</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="font-bold mt-2">Adopt Your New Friend!</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <h3 className="text-xl font-bold mb-4">Why We Created This</h3>
          <p className="">
        ...
        {/* Join Us Section */}
        <div>
          <h4 className="text-xl font-bold mb-4">Join Us in Making a Difference</h4>
          <p className="">
